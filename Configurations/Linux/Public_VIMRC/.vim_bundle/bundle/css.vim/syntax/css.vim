...
syn region cssAspxDirective start=+^<%@+ end=+%>$+ contains=cssAspxAttrib,cssStringQQ,cssStringQ
syn match cssAspxAttrib "\w\+="
...
syn region cssMediaBlock transparent matchgroup=cssBraces start='{' end='}' contains=cssTagName,cssError,cssAspxCode,cssAspxComment,cssComment,cssDefinition,cssURL,cssUnicodeEscape,cssIdentifier
...
syn region cssFontDescriptorBlock contained transparent matchgroup=cssBraces start="{" end="}" contains=cssAspxCode,cssAspxComment,cssComment,cssError,cssUnicodeEscape,cssFontProp,cssFontAttr,cssCommonAttr,cssStringQ,cssStringQQ,cssFontDescriptorProp,cssValue.*,cssFontDescriptorFunction,cssUnicodeRange,cssFontDescriptorAttr
...
syn keyword cssColorProp contained color opacity filter
syn match cssColorProp contained "\<background\(-\(color\|image\|attachment\|position\)\)\="
syn keyword cssColorAttr contained center scroll fixed alpha
...
syn region cssInclude start="@import" end=";" contains=cssAspxCode,cssAspxComment,cssComment,cssURL,cssUnicodeEscape,cssMediaType
syn match cssBraces contained "[{}]"
syn match cssError contained "{@<>"
syn region cssDefinition transparent matchgroup=cssBraces start='{' end='}' contains=css.*Attr,css.*Prop,cssAspxCode,cssAspxComment,cssComment,cssValue.*,cssColor,cssURL,cssImportant,cssError,cssStringQ,cssStringQQ,cssFunction,cssUnicodeEscape
...
syn region cssAspxComment start=+<%--+ end=+--%>+
syn region cssAspxCode start="<% " end="%>"
syn region cssAspxCode start="<%=" end="%>"
...
if version >= 508 || !exists("did_css_syn_inits")
  ...
  HiLink cssAspxAttrib        Identifier
  HiLink cssAspxDirective     Special
  HiLink cssAspxCode	     PreProc
  HiLink cssAspxComment	     Comment
