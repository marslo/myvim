...
" Mappings for taskpaper
map <silent> <LocalLeader>td :call <SID>ToggleDone()<CR>
map <silent> <LocalLeader>tc :call <SID>ShowContext()<CR>
map <silent> <LocalLeader>ta :call <SID>ShowAll()<CR>
map <silent> <LocalLeader>tp :call <SID>FoldAllProjects()<CR>
