...
" Last Change:	2006 November 06
" Location:	http://mythago.net/raven.vim

" Note: This is a keyword for inserting imap from the text imap file. It is
" not Raven, but I put it here for convenience or ignorance.
syn match imapPlaceholder       /<++>/

syn keyword ravenWordDefinition	class define extend group
syn keyword ravenWordControl	repeat each while until if else continue leave break bye scope
