...
function! python_ftplugin#misc#escape#pattern(string) " {{{1
...
function! python_ftplugin#misc#escape#substitute(string) " {{{1
  " Takes a single string argument and converts it into a [:substitute]
...
function! python_ftplugin#misc#escape#shell(string) " {{{1
