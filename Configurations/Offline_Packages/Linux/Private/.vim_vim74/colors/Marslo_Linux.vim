...
" let g:colors_name="desert_Marslo_ForLinux_v3"
let g:colors_name="Marslo_Linux"
...
hi CursorLine   guibg=background ctermbg=NONE cterm=none
"hi CursorIM
"hi Directory
"hi DiffAdd
"hi DiffChange
...
hi Cursor       cterm=NONE      term=none
